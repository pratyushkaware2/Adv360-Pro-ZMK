# Advantage360 momentary Mouse mode

Hold the bottom inner-left key (beside G) to use H/J/K/L for movement,
U/I for left/right click and O for middle click. Tap Y to latch left click;
tap Y again to release it. Letting go of Mouse or pressing Escape stops
...
and delegates movement acceleration to the vendor mmv behavior. Mode exit
...
Run `python3 bin/check_keymap.py` and compile/run `bin/test_mouse_state.c`
...
Y then movement then Y for drag; release Mouse during movement/drag; Escape;
